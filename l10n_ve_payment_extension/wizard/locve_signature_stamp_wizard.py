...
class LocVeSignatureStampWizard(models.TransientModel):
    _name = "locve.signature.stamp.wizard"
    _description = "LocVe — Asistente de Firma y Sello de la Empresa"
    ...
    def default_get(self, fields_list):
        res = super(LocVeSignatureStampWizard, self).default_get(fields_list)
